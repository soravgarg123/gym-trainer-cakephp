                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-7">
                        <div class="trainee_top_wrap trainer_banner">
                            ...
                            <div class="trainee_detail">
                                <h1 class="trainee_name"><?php echo $trainer_profile_details[0]['trainer_name']." ".$trainer_profile_details[0]['trainer_lname']; ?></h1>
                                <div>
                                    <h3 class="trainee_rank">Rank Level :</h3>
                                    <div class="dashboard_rating"><input class="trainer-rank" value="<?php echo $trainer_profile_details[0]['trainer_rating']; ?>" type="number" /></div>
                                </div>
                                <nav class="trainee_streams">
                                <?php if(!empty($trainer_profile_details[0]['trainer_skills'])) { ?>
                                     <ul>
                                        <?php $skills =  $trainer_profile_details[0]['trainer_skills']; 
                                ...
                                <nav class="trainee_social_link">
                                    <ul>
                                    <?php
                                        if(!empty($trainer_profile_details[0]['trainer_linkedin'])) { ?>
                                    <li><a target="_blank" href="<?php echo $trainer_profile_details[0]['trainer_linkedin']; ?>" title="Linked In" class="linkedin_grad"><span class="fa fa-linkedin"></span></a></li>
                                    <?php } ?>
                                    <?php
                                        if(!empty($trainer_profile_details[0]['trainer_facebook'])) { ?>
                                    <li><a target="_blank" href="<?php echo $trainer_profile_details[0]['trainer_facebook']; ?>" title="Facebook" class="facebook_grad"><span class="fa fa-facebook"></span></a></li>
                                    <?php } ?>
                                    <?php
                                        if(!empty($trainer_profile_details[0]['trainer_twitter'])) { ?>
                                    <li><a target="_blank" href="<?php echo $trainer_profile_details[0]['trainer_twitter']; ?>" title="Twitter" class="twitter_grad"><span class="fa fa-twitter"></span></a></li>
                                    <?php } ?>
                                    <?php
                                        if(!empty($trainer_profile_details[0]['trainer_belibitv'])) { ?>
                                    <li><a target="_blank" href="<?php echo $trainer_profile_details[0]['trainer_belibitv']; ?>" title="BelibiTv" class="belibitv_grad"><span class="belivitv_icon"><img src="<?php echo $this->request->webroot; ?>img/favicon.png"></span></a></li>
                                    <?php } ?>
                                    <?php
                                        if(!empty($trainer_profile_details[0]['trainer_google'])) { ?>
                                    <li><a target="_blank" href="<?php echo $trainer_profile_details[0]['trainer_google']; ?>" title="Google" class="google_grad"><span class="fa fa-google-plus"></span></a></li>
                                    <?php } ?>
                                    <?php
                                        if(!empty($trainer_profile_details[0]['trainer_instagram'])) { ?>
                                    <li><a target="_blank" href="<?php echo $trainer_profile_details[0]['trainer_instagram']; ?>" title="Instagram" class="instagram_grad"><span class="fa fa-instagram"></span></a></li>
                                    <?php } ?>
                    ...
                    if(!empty($rate_plans)) { ?>
                        <ul class="session_list">
                            <li><h3>1 Session</h3><h2>$<?php echo $rate_plans[0]['rate_hour'] - $rate_plans[0]['adgust1']; ?><span></span></h2><a href="<?php echo ($user['user_type'] == "trainer" || $user['user_type'] == "") ? "javascript:void(0)" : $this->request->webroot."trainees/bookingSession?session=1&rid=".base64_encode($rate_plans[0]['rate_id'])."&tid=".base64_encode($trainer_profile_details[0]['user_id']); ?>">Order Now</a></li>
                            <li><h3>3 Sessions</h3><h2>$<?php echo ( 3 * $rate_plans[0]['rate_hour'] ) - $rate_plans[0]['adgust2']; ?><span></span></h2><a href="<?php echo ($user['user_type'] == "trainer" || $user['user_type'] == "") ? "javascript:void(0)" : $this->request->webroot."trainees/bookingSession?session=3&rid=".base64_encode($rate_plans[0]['rate_id'])."&tid=".base64_encode($trainer_profile_details[0]['user_id']); ?>">Order Now</a></li>
                            <li><h3>10 Sessions</h3><h2>$<?php echo ( 10 * $rate_plans[0]['rate_hour'] ) - $rate_plans[0]['adgust3']; ?><span></span></h2><a href="<?php echo ($user['user_type'] == "trainer" || $user['user_type'] == "") ? "javascript:void(0)" : $this->request->webroot."trainees/bookingSession?session=10&rid=".base64_encode($rate_plans[0]['rate_id'])."&tid=".base64_encode($trainer_profile_details[0]['user_id']); ?>">Order Now</a></li>
                            <li><h3>20 Sessions</h3><h2>$<?php echo ( 20 * $rate_plans[0]['rate_hour'] ) - $rate_plans[0]['adgust4']; ?><span></span></h2><a href="<?php echo ($user['user_type'] == "trainer" || $user['user_type'] == "") ? "javascript:void(0)" : $this->request->webroot."trainees/bookingSession?session=20&rid=".base64_encode($rate_plans[0]['rate_id'])."&tid=".base64_encode($trainer_profile_details[0]['user_id']); ?>">Order Now</a></li>
                        </ul>
                    <?php } ?>
                    <div class="clearfix"></div>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="trainer_profile_wrap">
                        <ul>
                            <li>
                                ...
                                <?php echo $trainer_profile_details[0]['biography']; ?>
                                </div>
                            </li>
                            <li>
                                <div class="profile_field_title">
                                ...
                                <div class="profile_field_des">
                                <?php echo $trainer_profile_details[0]['certification']; ?>
                                </div>
                            </li>
                            <li>
                                <div class="profile_field_title">
                                ...
                                <div class="profile_field_des">
                                    <?php echo $trainer_profile_details[0]['awards']; ?>
                                </div>
                            </li>
                            <li>
                                <div class="profile_field_title">
                                ...
                                <div class="profile_field_des">
                               <?php echo $trainer_profile_details[0]['accomplishments']; ?>
                                </div>
                            </li>
                            <li>
                                <div class="profile_field_title">
                                ...
                                <div class="profile_field_des">
                                    <?php echo $trainer_profile_details[0]['location']; ?>
                                </div>
                            </li>
                            <li>
                                <div class="profile_field_title">
                                ...
                                <div class="profile_field_des">
                                 <?php echo $trainer_profile_details[0]['credentials']; ?>
                                </div>
                            </li>
                            <li>
                                <div class="profile_field_title">
                                ...
                                <div class="profile_field_des">
                               <?php echo $trainer_profile_details[0]['interests_hobby']; ?>
                                </div>
                            </li>
                            <li>
                                <div class="profile_field_title">
                                ...
                                <div class="profile_field_des">
                               <?php echo $trainer_profile_details[0]['hobby']; ?>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <?php if(!empty($custom_packages)) { ?>
                    ...
                    <?php foreach($custom_packages as $cm) { ?>
                        <li><h3><?php echo $cm['package_name']; ?></h3><p><?php echo $cm['package_discription']; ?></p><h2>$<?php echo $cm['package_price']; ?></h2><a href=" <?php echo ($user['user_type'] == "trainer" || $user['user_type'] == "") ? "javascript:void(0)" : $this->request->webroot."trainees/purchaseCustomPackages?cid=".base64_encode($cm['package_id'])."&tid=".base64_encode($trainer_profile_details[0]['user_id']); ?>">Order Now</a></li>
                    <?php } ?>
                    </ul>
                <?php } ?>
                </div>
                    ...
                    <div class="trainer_review">
                        <div class="panel_block">
                            <div class="panel_block_heading review_heading">
                                <h3><?php echo ucwords($trainer_profile_details[0]['trainer_name']." ".$trainer_profile_details[0]['trainer_lname']); ?> Reviews*</h3>
                            </div>
