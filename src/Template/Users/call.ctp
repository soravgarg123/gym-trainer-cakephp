<div class="video_chat_wrapper">
    <div class="m_video_chat_head">Voice Chat</div>
            ...
            <div class="full_video">
                ...
                <div class="video_sect_footer">
                    ...
                    <div class="full_screen_vid1">
                        <!-- <button type="button"><i class="fa fa-arrows-alt"></i></button> -->
                    </div>
                </div>
            </div>
        </div>
...
function videocall()
{
    ...
    session.on("streamCreated", function (event) {
        ...
        var subscriber = session.subscribe(event.stream, subContainer,subOptions);
        if (!subscriber.stream.hasVideo)
        {
            subscriber.setStyle('backgroundImageURI', "<?php echo $this->request->webroot; ?>img/default.png");
        } 
        // else {
...
/* For Chatting Start */
   ...
   $('#load_chat_<?php echo $unique; ?>').animate({scrollTop: $('#load_chat_<?php echo $unique; ?>')[0].scrollHeight}, 1000);     
