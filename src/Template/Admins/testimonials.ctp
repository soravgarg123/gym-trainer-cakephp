            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-9">
                     ...
                     <div class="col-md-3">  
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal" style="float:right;" class="btn btn-primary"><i class="fa fa-plus"> Add Testimonials</i></a>   
                    </div>
                    </div>
                </div>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Testimonials</h4>
                          </div>
                          <div class="modal-body">
                            <?php echo $this->Custom->errorMsg(); ?>
                            <form method="post" action="<?php echo $this->request->webroot; ?>admins/addTestimonials" enctype="multipart/form-data">
                          <div class="col-md-12">                        
                              <div class="col-md-4">
                                  Image
                              </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <?php $i = 1; 
                                        ...
                                        <tr id="row_<?php echo $t['id']; ?>">
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="delete" title="Delete Testimonials" main="<?php echo $t['id']; ?>"><i class="fa fa-trash-o"></i></a> 
                                            </td>
                                        </tr>
                                    <?php $i++; } ?> 
                                    </tbody>
