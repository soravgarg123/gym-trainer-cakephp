...
/************************************************************************************************
***********************************jquery owl carousel end  ***********************************
************************************************************************************************/



/*******************************************************************************************************
***********************************bootstrap select picker js start  ***********************************
*******************************************************************************************************/
/*!
...
/*******************************************************************************************************
***********************************bootstrap select picker js end  ***********************************
*******************************************************************************************************/


/*******************************************************************************************************
***********************************bootstrap calendar  js  start     ***********************************
*******************************************************************************************************/
...
d.isIE&&(document.detachEvent("onmousemove",d.handleMouseMove),document.detachEvent("onmouseup",d.handleMouseUp),window.detachEvent("onload",d.handleLoad))};d.makeChart=function(a,b,c){var e=b.type,g=b.theme;d.isString(g)&&(g=d.themes[g],b.theme=g);var f;switch(e){case "serial":f=new d.AmSerialChart(g);break;case "xy":f=new d.AmXYChart(g);break;case "pie":f=new d.AmPieChart(g);break;case "radar":f=new d.AmRadarChart(g);break;case "gauge":f=new d.AmAngularGauge(g);break;case "funnel":f=new d.AmFunnelChart(g);
break;case "map":f=new d.AmMap(g);break;case "stock":f=new d.AmStockChart(g);break;case "gantt":f=new d.AmGanttChart(g)}d.extend(f,b);d.isReady?isNaN(c)?f.write(a):setTimeout(function(){d.realWrite(f,a)},c):d.ready(function(){isNaN(c)?f.write(a):setTimeout(function(){d.realWrite(f,a)},c)});return f};d.realWrite=function(a,b){a.write(b)};d.updateCount=0;d.validateAt=Math.round(d.updateRate/10);d.update=function(){var a=d.charts;d.updateCount++;var b=!1;d.updateCount==d.validateAt&&(b=!0,d.updateCount=
...
e=this.legend,g=c.style,f=b.style;this.measure();this.previousHeight=this.divRealHeight;this.previousWidth=this.divRealWidth;var h,k=document.createElement("div");h=k.style;h.position="relative";this.containerDiv=k;k.className=this.classNamePrefix+"-main-div";b.className=this.classNamePrefix+"-chart-div";a.appendChild(k);var l=this.exportConfig;l&&d.AmExport&&!this.AmExport&&(this.AmExport=new d.AmExport(this,l));this.amExport&&d.AmExport&&(this.AmExport=d.extend(this.amExport,new d.AmExport(this),
!0));this.AmExport&&this.AmExport.init&&this.AmExport.init();if(e){e=this.addLegend(e,e.divId);if(e.enabled)switch(g.left=null,g.top=null,g.right=null,f.left=null,f.right=null,f.top=null,g.position="relative",f.position="relative",e.position){case "bottom":k.appendChild(b);k.appendChild(c);break;case "top":k.appendChild(c);k.appendChild(b);break;case "absolute":h.width=a.style.width;h.height=a.style.height;g.position="absolute";f.position="absolute";void 0!==e.left&&(g.left=e.left+"px");void 0!==
e.right&&(g.right=e.right+"px");void 0!==e.top&&(g.top=e.top+"px");void 0!==e.bottom&&(g.bottom=e.bottom+"px");e.marginLeft=0;e.marginRight=0;k.appendChild(b);k.appendChild(c);break;case "right":h.width=a.style.width;h.height=a.style.height;g.position="relative";f.position="absolute";k.appendChild(b);k.appendChild(c);break;case "left":h.width=a.style.width;h.height=a.style.height;g.position="absolute";f.position="relative";k.appendChild(b);k.appendChild(c);break;case "outside":k.appendChild(b)}else k.appendChild(b);
...
e=this.marginTopReal,d=c+this.plotAreaWidth,f=e+this.plotAreaHeight;var h=a+"/javascript-charts/",k="JavaScript charts",l="";"ammap"==this.product&&(h=a+"/javascript-maps/",k="Interactive JavaScript maps",l="");a=document.createElement("a");l=document.createTextNode(l);a.setAttribute("href",h);a.setAttribute("title",k);this.urlTarget&&a.setAttribute("target",this.urlTarget);a.appendChild(l);this.chartDiv.appendChild(a);this.amLink=a;h=a.style;h.position="absolute";
h.textDecoration="none";h.color=this.color;h.fontFamily=this.fontFamily;h.fontSize="11px";h.opacity=.7;h.display="block";var k=a.offsetWidth,a=a.offsetHeight,l=5+c,m=e+5;"bottom-left"==b&&(l=5+c,m=f-a-3);"bottom-right"==b&&(l=d-k-5,m=f-a-3);"top-right"==b&&(l=d-k-5,m=e+5);h.left=l+"px";h.top=m+"px"}}}});d.Slice=d.Class({construct:function(){}});d.SerialDataItem=d.Class({construct:function(){}});d.GraphDataItem=d.Class({construct:function(){}});d.Guide=d.Class({construct:function(a){this.cname="Guide";
...
B<k&&(B=k);w<h&&(w=h);w+y>l&&(w=l-y);var k=B+u,m=w+p,G=this.shadowAlpha,D=this.shadowColor,p=this.borderThickness,K=this.bulletSize,J,u=this.fillAlpha,L=this.borderAlpha;this.showBullet&&(J=d.circle(g,K,r,u),f.push(J));this.drop?(h=y/1.6,l=0,"V"==x&&(x="down"),"H"==x&&(x="left"),"down"==x&&(w=a+1,B=b-h-h/3),"up"==x&&(l=180,w=a+1,B=b+h+h/3),"left"==x&&(l=270,w=a+h+h/3+2,B=b),"right"==x&&(l=90,w=a-h-h/3+2,B=b),k=B-E/2+1,m=w-F/2-1,q=d.drop(g,h,l,q,u,p,t,L)):0<z||0===A?(0<G&&(a=d.rect(g,y,v,q,0,p+1,D,
...
c,a.handDrawScatter),b=c[0],c=c[1]);h=Math.round;m&&(b[r]=d.roundTo(b[r],5),c[r]=d.roundTo(c[r],5),h=Number);k="M"+(h(b[0])+n)+","+(h(c[0])+f);for(var r=1;r<b.length;r++)m&&(b[r]=d.roundTo(b[r],5),c[r]=d.roundTo(c[r],5)),k+=" L"+(h(b[r])+n)+","+(h(c[r])+f);a=a.path(k+" Z").attr(g);t&&a.gradient("linearGradient",e,l);return a};d.rect=function(a,b,c,e,g,f,h,k,l,m,n){if(isNaN(b)||isNaN(c))return a.set();isNaN(f)&&(f=0);void 0===l&&(l=0);void 0===m&&(m=270);isNaN(g)&&(g=0);var q=e,t=!1;"object"==typeof q&&
(q=q[0],t=!0);void 0===h&&(h=q);void 0===k&&(k=g);b=Math.round(b);c=Math.round(c);var r=0,p=0;0>b&&(b=Math.abs(b),r=-b);0>c&&(c=Math.abs(c),p=-c);r+=d.dx;p+=d.dy;g={fill:q,stroke:h,"fill-opacity":g,"stroke-opacity":k};void 0!==n&&0<n&&(g["stroke-dasharray"]=n);a=a.rect(r,p,b,c,l,f).attr(g);t&&a.gradient("linearGradient",e,m);return a};d.bullet=function(a,b,c,e,g,f,h,k,l,m,n,q,t){var r;"circle"==b&&(b="round");switch(b){case "round":r=d.circle(a,c/2,e,g,f,h,k);break;case "square":r=d.polygon(a,[-c/
2,c/2,c/2,-c/2],[c/2,c/2,-c/2,-c/2],e,g,f,h,k,m-180,void 0,t);break;case "rectangle":r=d.polygon(a,[-c,c,c,-c],[c/2,c/2,-c/2,-c/2],e,g,f,h,k,m-180,void 0,t);break;case "diamond":r=d.polygon(a,[-c/2,0,c/2,0],[0,-c/2,0,c/2],e,g,f,h,k);break;case "triangleUp":r=d.triangle(a,c,0,e,g,f,h,k);break;case "triangleDown":r=d.triangle(a,c,180,e,g,f,h,k);break;case "triangleLeft":r=d.triangle(a,c,270,e,g,f,h,k);break;case "triangleRight":r=d.triangle(a,c,90,e,g,f,h,k);break;case "bubble":r=d.circle(a,c/2,e,g,
f,h,k,!0);break;case "line":r=d.line(a,[-c/2,c/2],[0,0],e,g,f,h,k);break;case "yError":r=a.set();r.push(d.line(a,[0,0],[-c/2,c/2],e,g,f));r.push(d.line(a,[-l,l],[-c/2,-c/2],e,g,f));r.push(d.line(a,[-l,l],[c/2,c/2],e,g,f));break;case "xError":r=a.set(),r.push(d.line(a,[-c/2,c/2],[0,0],e,g,f)),r.push(d.line(a,[-c/2,-c/2],[-l,l],e,g,f)),r.push(d.line(a,[c/2,c/2],[-l,l],e,g,f))}r&&r.pattern(n,NaN,q);return r};d.triangle=function(a,b,c,e,d,f,h,k){if(void 0===f||0===f)f=1;void 0===h&&(h="#000");void 0===
...
(l+c+u)+","+F+","+(l+z)+","+x+","+(l+v)))):(D+=" A"+f+","+h+",0,"+H+",1,"+w+","+(y+l)+" L"+F+","+(z+l),0<k&&(D+=" A"+k+","+u+",0,"+H+",0,"+x+","+(v+l)));D+=" Z";var K=l;A&&(K/=10);for(var J=0;J<K;J+=10){var L=a.path(D,void 0,void 0,"1000,1000").attr(E);e.push(L);L.translate(0,-J)}D=a.path(" M"+x+","+v+" L"+x+","+(v+l)+" L"+B+","+(C+l)+" L"+B+","+C+" L"+x+","+v+" Z",void 0,void 0,"1000,1000").attr(E);l=a.path(" M"+w+","+y+" L"+w+","+(y+l)+" L"+F+","+(z+l)+" L"+F+","+z+" L"+w+","+y+" Z",void 0,void 0,
"1000,1000").attr(E);e.push(D);e.push(l)}A?(G||(g=" A"+p(b-f)+","+p(c-h)+","+p(b+f)+","+p(c+h)+","+p(B)+","+p(C)+","+p(w)+","+p(y)),h=" M"+p(x)+","+p(v)+" L"+p(B)+","+p(C)+g+" L"+p(F)+","+p(z)):h=" M"+x+","+v+" L"+B+","+C+(" A"+f+","+h+",0,"+H+",1,"+w+","+y)+" L"+F+","+z;0<k&&(A?G||(h+=" B"+(b-k)+","+(c-u)+","+(b+k)+","+(c+u)+","+F+","+z+","+x+","+v):h+=" A"+k+","+u+",0,"+H+",0,"+x+","+v);a.handDrawn&&(k=d.line(a,[x,B],[v,C],m.stroke,m.thickness*Math.random()*a.handDrawThickness,m["stroke-opacity"]),
e.push(k));a=a.path(h+" Z",void 0,void 0,"1000,1000").attr(m);if(n){k=[];for(u=0;u<n.length;u++)k.push(d.adjustLuminosity(m.fill,n[u]));"radial"!=r||d.isModern||(k=[]);0<k.length&&a.gradient(r+"Gradient",k)}d.isModern&&"radial"==r&&a.grad&&(a.grad.setAttribute("gradientUnits","userSpaceOnUse"),a.grad.setAttribute("r",f),a.grad.setAttribute("cx",b),a.grad.setAttribute("cy",c));a.pattern(q,NaN,t);e.wedge=a;e.push(a);return e};d.rgb2hex=function(a){return(a=a.match(/^rgba?[\s+]?\([\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?/i))&&
...
g=this.marginBottom,f=this.horizontalGap,h=this.div,k=this.divWidth,l=this.maxColumnsReal,m=this.verticalGap,n=this.spacing,q=k-c-b,t=0,r=0,p=this.container;this.set&&this.set.remove();var u=p.set();this.set=u;var A=p.set();u.push(A);var x=this.entries,z,v;for(v=0;v<x.length;v++){z=x[v].getBBox();var B=z.width;B>t&&(t=B);z=z.height;z>r&&(r=z)}var B=r=0,C=f,w=0,y=0;for(v=0;v<x.length;v++){var F=x[v];this.reversedOrder&&(F=x[x.length-v-1]);z=F.getBBox();var E;this.equalWidths?E=B*(t+n+this.markerLabelGap):
(E=C,C=C+z.width+f+n);z.height>y&&(y=z.height);E+z.width>q&&0<v&&0!==B&&(r++,E=B=0,C=E+z.width+f+n,w=w+y+m,y=0);F.translate(E,w);B++;!isNaN(l)&&B>=l&&(B=0,r++,w=w+y+m,C=f,y=0);A.push(F)}z=A.getBBox();l=z.height+2*m-1;"left"==a||"right"==a?(n=z.width+2*f,k=n+b+c,h.style.width=k+"px",this.ieW=k):n=k-b-c-1;c=d.polygon(this.container,[0,n,n,0],[0,0,l,l],this.backgroundColor,this.backgroundAlpha,1,this.borderColor,this.borderAlpha);d.setCN(this.chart,c,"legend-bg");u.push(c);u.translate(b,e);c.toBack();
...
this.linkSet.toFront()}else this.cleanChart()},hideGroup:function(a){this.showHideGroup(a,!1)},showGroup:function(a){this.showHideGroup(a,!0)},showHideGroup:function(a,b){this.showHideReal(this.imagesProcessor.allObjects,a,b);this.showHideReal(this.areasProcessor.allObjects,a,b);this.showHideReal(this.linesProcessor.allObjects,a,b)},showHideReal:function(a,b,c){var e;for(e=0;e<a.length;e++){var d=a[e];if(d.groupId==b){var f=d.displayObject;f&&(c?(d.hidden=!1,f.show()):(d.hidden=!0,f.hide()))}}},makeObjectAccessible:function(a){if(a.accessibleLabel){var b=
this.formatString(a.accessibleLabel,a);a.displayObject&&this.makeAccessible(a.displayObject,b)}},update:function(){d.hasSVG&&(d.AmMap.base.update.call(this),this.zoomControl&&this.zoomControl.update&&this.zoomControl.update())},animateMap:function(){var a=this;a.totalFrames=a.zoomDuration*d.updateRate;a.totalFrames+=1;a.frame=0;a.tweenPercent=0;a.balloon.hide(0);setTimeout(function(){a.updateSize.call(a)},1E3/d.updateRate)},updateSize:function(){var a=this,b=a.totalFrames;a.preventHover=!0;a.frame<=
...
setTimeout(function(){c.processObjects.call(c)},1E3*e+200)):b||c.processObjects();e=a.displayObject;f=a.selectedColorReal;"MapImage"==a.objectType&&(h=c.imagesSettings.selectedOutlineColor,k=c.imagesSettings.selectedOutlineThickness,e=a.image);if(e){if(d.setCN(c,e,"selected-object"),a.bringForwardOnHover&&a.displayObject.toFront(),!a.preserveOriginalAttributes){e.setAttr("stroke",a.outlineColorReal);void 0!==f&&e.setAttr("fill",f);void 0!==h&&e.setAttr("stroke",h);void 0!==k&&e.setAttr("stroke-width",
k);if("MapLine"==a.objectType){var l=a.lineSvg;l&&l.setAttr("stroke",f);if(l=a.arrowSvg)l.setAttr("fill",f),l.setAttr("stroke",f)}if(l=a.imageLabel){var m=a.selectedLabelColorReal;void 0!==m&&l.setAttr("fill",m)}a.selectable||(e.setAttr("cursor","default"),l&&l.setAttr("cursor","default"))}}else c.returnInitialColorReal(a);if(e=a.groupId)for(l=a.groupArray,l||(l=c.getGroupById(e),a.groupArray=l),m=0;m<l.length;m++){var n=l[m];n.isOver=!1;e=n.displayObject;"MapImage"==n.objectType&&(e=n.image);if(e){var q=
n.selectedColorReal;void 0!==q&&e.setAttr("fill",q);void 0!==h&&e.setAttr("stroke",h);void 0!==k&&e.setAttr("stroke-width",k);"MapLine"==n.objectType&&((e=n.lineSvg)&&e.setAttr("stroke",f),e=n.arrowSvg)&&(e.setAttr("fill",f),e.setAttr("stroke",f))}}c.zoomToSelectedObject();g!=a&&c.fire({type:"selectedObjectChanged",chart:c})},returnInitialColor:function(a,b){this.returnInitialColorReal(a);b&&(a.isFirst=!1);if(this.selectedObject.bringForwardOnHover){var c=this.selectedObject.displayObject;c&&c.toFront()}if(c=
a.groupId){var c=this.getGroupById(c),e;for(e=0;e<c.length;e++)this.returnInitialColorReal(c[e]),b&&(c[e].isFirst=!1)}},closeAllDescriptions:function(){this.descriptionsDiv.innerHTML=""},returnInitialColorReal:function(a){a.isOver=!1;var b=a.displayObject;if(b){b.toPrevious();if("MapImage"==a.objectType){var c=a.tempScale;isNaN(c)||b.translate(b.x,b.y,c,!0);a.tempScale=NaN;b=a.image}c=a.colorReal;if("MapLine"==a.objectType){var e=a.lineSvg;e&&e.setAttr("stroke",c);if(e=a.arrowSvg)e.setAttr("fill",
...
(b.toFront(),a.isFirst=!0);var c=a.rollOverColorReal,e;a.preserveOriginalAttributes&&(c=void 0);void 0==c&&(isNaN(a.rollOverBrightnessReal)||(c=d.adjustLuminosity(a.colorReal,a.rollOverBrightnessReal/100)));if(void 0!=c)if("MapImage"==a.objectType)(e=a.image)&&e.setAttr("fill",c);else if("MapLine"==a.objectType){if((e=a.lineSvg)&&e.setAttr("stroke",c),e=a.arrowSvg)e.setAttr("fill",c),e.setAttr("stroke",c)}else b.setAttr("fill",c);(c=a.imageLabel)&&!a.labelInactive&&(e=a.labelRollOverColorReal,void 0!=
e&&c.setAttr("fill",e));c=a.rollOverOutlineColorReal;void 0!=c&&("MapImage"==a.objectType?(e=a.image)&&e.setAttr("stroke",c):b.setAttr("stroke",c));"MapImage"==a.objectType?(c=this.imagesSettings.rollOverOutlineThickness,(e=a.image)&&(isNaN(c)||e.setAttr("stroke-width",c))):(c=this.areasSettings.rollOverOutlineThickness,isNaN(c)||b.setAttr("stroke-width",c));if("MapArea"==a.objectType){c=this.areasSettings;e=a.rollOverAlphaReal;isNaN(e)||b.setAttr("fill-opacity",e);e=c.rollOverOutlineAlpha;isNaN(e)||
b.setAttr("stroke-opacity",e);e=1;this.areasSettings.adjustOutlineThickness&&(e=this.zoomLevel()*this.mapScale);var g=c.rollOverOutlineThickness;isNaN(g)||b.setAttr("stroke-width",g/e);(c=c.rollOverPattern)&&b.pattern(c,this.mapScale,this.path)}"MapImage"==a.objectType&&(c=a.rollOverScaleReal,isNaN(c)||1==c||(e=b.scale,isNaN(e)&&(e=1),a.tempScale=e,b.translate(b.x,b.y,e*c,!0)));this.useHandCursorOnClickableOjects&&this.checkIfClickable(a)&&b.setAttr("cursor","pointer");a.mouseEnabled&&this.addObjectEventListeners(b,
a);a.isOver=!0}},rollOverMapObject:function(a,b,c){if(this.chartCreated){this.handleMouseMove();var d=this.previouslyHovered;d&&d!=a?(!1===this.checkIfSelected(d)&&(this.returnInitialColor(d,!0),this.previouslyHovered=null),this.balloon.hide(0)):clearTimeout(this.hoverInt);if(!this.preventHover){if(!1===this.checkIfSelected(a)){if(d=a.groupId){var d=this.getGroupById(d),g;for(g=0;g<d.length;g++)d[g]!=a&&this.showAsRolledOver(d[g])}this.showAsRolledOver(a)}else(d=a.displayObject)&&(this.allowClickOnSelectedObject?
d.setAttr("cursor","pointer"):d.setAttr("cursor","default"));this.showDescriptionOnHover?this.showDescription(a):!this.showBalloonOnSelectedObject&&this.checkIfSelected(a)||!1===b||(g=this.balloon,this.balloon.fixedPosition=!1,b=a.colorReal,d="",void 0!==b&&this.useObjectColorForBalloon||(b=g.fillColor),(g=a.balloonTextReal)&&(d=this.formatString(g,a)),this.balloonLabelFunction&&(d=this.balloonLabelFunction(a,this)),"MapArea"!=a.objectType&&(this.balloonX=NaN),d&&""!==d&&this.showBalloon(d,b,!1,this.balloonX,
this.balloonY));this.fire({type:"rollOverMapObject",mapObject:a,chart:this,event:c});this.previouslyHovered=a}}},longitudeToX:function(a){return(this.longitudeToCoordinate(a)+this.diffX*this.mapScale)*this.zoomLevel()+this.mapContainer.x},latitudeToY:function(a){return(this.latitudeToCoordinate(a)+this.diffY*this.mapScale)*this.zoomLevel()+this.mapContainer.y},latitudeToStageY:function(a){return this.latitudeToCoordinate(a)*this.zoomLevel()+this.mapContainer.y+this.diffY*this.mapScale},longitudeToStageX:function(a){return this.longitudeToCoordinate(a)*
...
n=c.buttonBorderColor,q=c.buttonBorderAlpha,t=c.buttonCornerRadius,r=c.buttonRollOverColor,p=c.gridHeight,u=c.zoomFactor,A=c.minZoomLevel,x=c.maxZoomLevel,z=c.buttonIconAlpha,v=c.buttonIconColor,B=c.roundButtons,C=a.svgIcons,w=a.getX(c.left),y=a.getY(c.top);isNaN(c.right)||(w=a.getX(c.right,!0),w=h?w-3*g:w-g);isNaN(c.bottom)||(y=a.getY(c.bottom,!0),f&&(y-=p+3*g),y=h?y-3*g:c.homeButtonEnabled?y-.5*g:y+g);e.translate(w,y);c.previousDY=NaN;var F,w=g/4-1;if(f){F=b.set();d.setCN(a,F,"zoom-control-zoom");
...
[-w,0,w],[w/5,-w+w/5,w/5],v,z,1):u.setIcon(a.pathToImages+"panUp.gif",c.iconSize),u.setClickHandler(a.moveUp,a),u.init(b,g,g,k,l,m,n,q,t,r,z,v,B),u.set.translate(g,0),d.setCN(a,u.set,"pan-up"),h.push(u.set),u=new d.SimpleButton,C?u.svgIcon=d.line(b,[-w,0,w],[-w/5,w-w/5,-w/5],v,z,1):u.setIcon(a.pathToImages+"panDown.gif",c.iconSize),u.setClickHandler(a.moveDown,a),u.init(b,g,g,k,l,m,n,q,t,r,z,v,B),u.set.translate(g,2*g),d.setCN(a,u.set,"pan-down"),h.push(u.set),e.push(h));c.homeButtonEnabled&&(h=new d.SimpleButton,
...
(a.selectable=u);void 0==a.colorReal&&(a.colorReal=f);f=a.outlineColor;void 0==f&&(f=t);t=a.outlineAlpha;isNaN(t)&&(t=r);r=a.outlineThickness;isNaN(r)&&(r=k);k=a.rollOverOutlineColor;void 0==k&&(k=x);x=a.rollOverBrightness;void 0==x&&(x=q);void 0==a.bringForwardOnHover&&(a.bringForwardOnHover=z);void 0==a.preserveOriginalAttributes&&(a.preserveOriginalAttributes=v);isNaN(e.selectedBrightness)||(A=d.adjustLuminosity(a.colorReal,e.selectedBrightness/100));a.alphaReal=B;a.rollOverColorReal=n;a.rollOverAlphaReal=
h;a.balloonTextReal=m;a.selectedColorReal=A;a.outlineColorReal=f;a.outlineAlphaReal=t;a.rollOverOutlineColorReal=k;a.outlineThicknessReal=r;a.patternReal=l;a.rollOverBrightnessReal=x;a.accessibleLabel||(a.accessibleLabel=e.accessibleLabel);d.processDescriptionWindow(e,a);if(c&&(q=c.area,z=c.title,a.enTitle=c.title,z&&!a.title&&(a.title=z),(c=b.language)?(z=d.mapTranslations)&&(c=z[c])&&c[a.enTitle]&&(a.titleTr=c[a.enTitle]):a.titleTr=void 0,q)){a.displayObject=q;a.mouseEnabled&&b.addObjectEventListeners(q,
...
void 0==a.bringForwardOnHover&&(a.bringForwardOnHover=w);l=a.outlineAlpha;isNaN(l)&&(l=p);p=a.rollOverColor;void 0==p&&(p=m);m=a.selectedColor;void 0==m&&(m=q);q=a.balloonText;void 0===q&&(q=t);t=a.outlineColor;void 0==t&&(t=r);a.outlineColorReal=t;r=a.outlineThickness;isNaN(r)&&(r=u);(u=a.labelPosition)||(u=v);v=a.labelColor;void 0==v&&(v=B);B=a.labelRollOverColor;void 0==B&&(B=y);y=a.selectedLabelColor;void 0==y&&(y=E);E=a.labelFontSize;isNaN(E)&&(E=C);C=a.selectedScale;isNaN(C)&&(C=A);A=a.rollOverScale;
isNaN(A)&&(A=x);x=a.rollOverBrightness;void 0==x&&(x=F);void 0==a.selectable&&(a.selectable=z);a.colorReal=G;isNaN(h.selectedBrightness)||(m=d.adjustLuminosity(a.colorReal,h.selectedBrightness/100));a.alphaReal=k;a.rollOverColorReal=p;a.balloonTextReal=q;a.selectedColorReal=m;a.labelColorReal=v;a.labelRollOverColorReal=B;a.selectedLabelColorReal=y;a.labelFontSizeReal=E;a.labelPositionReal=u;a.selectedScaleReal=C;a.rollOverScaleReal=A;a.rollOverOutlineColorReal=n;a.rollOverBrightnessReal=x;a.accessibleLabel||
(a.accessibleLabel=h.accessibleLabel);d.processDescriptionWindow(h,a);a.centeredReal=void 0==a.centered?h.centered:a.centered;F=a.type;x=a.imageURL;A=a.svgPath;C=a.width;E=a.height;n=a.scale;isNaN(a.percentWidth)||(C=a.percentWidth/100*c.realWidth);isNaN(a.percentHeight)||(E=a.percentHeight/100*c.realHeight);var D;x||F||A||(F="circle",C=1,l=k=0);p=z=0;h=a.selectedColorReal;if(F){isNaN(C)&&(C=10);isNaN(E)&&(E=10);"kilometers"==a.widthAndHeightUnits&&(C=c.kilometersToPixels(a.width),E=c.kilometersToPixels(a.height));
...
"map-image-container-"+a.id));e=isNaN(a.latitude)||isNaN(a.longitude)?!0:!1;a.lineId&&(D=this.chart.getObjectById(a.lineId))&&0<D.longitudes.length&&(e=!1);e?f.push(H):g.push(H);H&&(H.rotation=a.rotation,isNaN(a.rotation)||H.rotate(a.rotation));this.updateSizeAndPosition(a);a.mouseEnabled&&c.addObjectEventListeners(H,a);a.hidden&&H.hide();a.animateAlongLine&&setTimeout(function(){a.animateAlong.call(a)},100);return a},updateSizeAndPosition:function(a){var b=this.chart,c=a.displayObject,e=b.getX(a.left),
g=b.getY(a.top),f,h=a.image.getBBox();isNaN(a.right)||(e=b.getX(a.right,!0)-h.width*a.scale);isNaN(a.bottom)||(g=b.getY(a.bottom,!0)-h.height*a.scale);var k=a.longitude,l=a.latitude,m=a.positionOnLine,h=this.objectsToResize;this.allSvgObjects.push(c);this.allObjects.push(a);a.arrays.push({arr:this.allSvgObjects,el:c});a.arrays.push({arr:this.allObjects,el:a});var n=a.imageLabel,q=this.chart.zoomLevel(),t,r;a.lineId&&(a.line=this.chart.getObjectById(a.lineId));b.makeObjectAccessible(a);if(a.line&&
a.line.getCoordinates){a.line.chart=b;var p=a.line.getCoordinates(m,a.lineSegment);p&&(k=b.coordinateToLongitude(p.x),l=b.coordinateToLatitude(p.y),t=p.x,r=p.y,a.animateAngle&&(f=d.radiansToDegrees(p.angle)))}isNaN(f)||c.rotate(f+a.extraAngle);if(!isNaN(e)&&!isNaN(g))c.translate(e,g,NaN,!0);else if(!isNaN(l)&&!isNaN(k))if(g=b.coordinatesToXY(k,l),e=g.x,g=g.y,isNaN(t)||(e=t),isNaN(r)||(g=r),a.fixedSize){t=1;if(a.showAsSelected||b.selectedObject==a)t=a.selectedScaleReal;b=a.positionScale;isNaN(b)?b=
0:(--b,b*=1-2*Math.abs(m-.5));m={image:c,scale:t+b};h.push(m);a.arrays.push({arr:h,el:m});c.translate(e,g,t/q+b,!0)}else c.translate(e,g,NaN,!0),n&&(this.labelsToReposition.push(a),a.arrays.push({arr:this.labelsToReposition,el:a}));this.positionLabel(n,a,a.labelPositionReal)},positionLabel:function(a,b,c){if(a){var d=b.image,g=0,f=0,h=0,k=0;d&&(k=d.getBBox(),f=d.y,g=d.x,h=k.width,k=k.height,b.svgPath&&(h*=b.scale,k*=b.scale));var d=a.getBBox(),l=d.width,m=d.height;"right"==c&&(g+=h+l/2+5,f+=k/2-2);
"left"==c&&(g+=-l/2-5,f+=k/2-2);"top"==c&&(f-=m/2+3,g+=h/2);"bottom"==c&&(f+=k+m/2,g+=h/2);"middle"==c&&(g+=h/2,f+=k/2);a.translate(g+b.labelShiftX,f+b.labelShiftY,NaN,!0);b.labelBG&&b.labelBG.translate(g-d.width/2+b.labelShiftX-9,f+b.labelShiftY-d.height/2-3,NaN,!0)}},createPredefinedImage:function(a,b,c,e,g,f){var h=this.chart.container,k;switch(e){case "circle":k=d.circle(h,g/2,a,1,c,b,1);break;case "rectangle":k=d.polygon(h,[-g/2,g/2,g/2,-g/2],[f/2,f/2,-f/2,-f/2],a,1,c,b,1,0,!0);break;case "bubble":k=
d.circle(h,g/2,a,1,c,b,1,!0);break;case "hexagon":g/=Math.sqrt(3),k=d.polygon(h,[.866*g,0*g,-.866*g,-.866*g,0*g,.866*g],[.5*g,1*g,.5*g,-.5*g,-1*g,-.5*g],a,1,c,b,1)}return k},reset:function(){this.objectsToResize=[];this.allSvgObjects=[];this.allObjects=[];this.allLabels=[];this.labelsToReposition=[]}})})();(function(){var d=window.AmCharts;d.ImagesSettings=d.Class({construct:function(a){this.cname="ImagesSettings";this.balloonText="[[title]]";this.alpha=1;this.borderAlpha=0;this.borderThickness=1;this.labelPosition="right";this.labelColor="#000000";this.labelFontSize=11;this.color="#000000";this.labelRollOverColor="#00CC00";this.centered=!0;this.rollOverScale=this.selectedScale=1;this.descriptionWindowWidth=250;this.bringForwardOnHover=!0;this.outlineColor="transparent";this.adjustAnimationSpeed=!1;
...
h=c.stageLinesContainer,k=e.thickness,l=e.dashLength,m=e.arrow,n=e.arrowSize,q=e.arrowColor,t=e.arrowAlpha,r=e.color,p=e.alpha,u=e.rollOverColor,A=e.selectedColor,x=e.rollOverAlpha,z=e.balloonText,v=e.bringForwardOnHover,B=e.arc,C=e.rollOverBrightness,w=c.container;a.chart=c;a.baseSettings=e;var y=w.set();a.displayObject=y;this.allSvgObjects.push(y);a.arrays.push({arr:this.allSvgObjects,el:y});this.allObjects.push(a);a.arrays.push({arr:this.allObjects,el:a});a.mouseEnabled&&c.addObjectEventListeners(y,
a);if(a.remainVisible||c.selectedObject==a.parentObject){var F=a.thickness;isNaN(F)&&(F=k);k=a.dashLength;isNaN(k)&&(k=l);l=a.color;void 0==l&&(l=r);r=a.alpha;isNaN(r)&&(r=p);p=a.rollOverAlpha;isNaN(p)&&(p=x);isNaN(p)&&(p=r);x=a.rollOverColor;void 0==x&&(x=u);u=a.selectedColor;void 0==u&&(u=A);A=a.balloonText;void 0===A&&(A=z);z=a.arc;isNaN(z)&&(z=B);B=a.arrow;if(!B||"none"==B&&"none"!=m)B=m;m=a.arrowColor;void 0==m&&(m=q);void 0==m&&(m=l);q=a.arrowAlpha;isNaN(q)&&(q=t);isNaN(q)&&(q=r);t=a.arrowSize;
isNaN(t)&&(t=n);n=a.rollOverBrightness;void 0==n&&(n=C);a.colorReal=l;isNaN(e.selectedBrightness)||(u=d.adjustLuminosity(a.colorReal,e.selectedBrightness/100));a.alphaReal=r;a.rollOverColorReal=x;a.rollOverAlphaReal=p;a.balloonTextReal=A;a.selectedColorReal=u;a.thicknessReal=F;a.rollOverBrightnessReal=n;a.accessibleLabel||(a.accessibleLabel=e.accessibleLabel);void 0===a.shiftArrow&&(a.shiftArrow=e.shiftArrow);void 0==a.bringForwardOnHover&&(a.bringForwardOnHover=v);d.processDescriptionWindow(e,a);
v=this.processCoordinates(a.x,c.realWidth);C=this.processCoordinates(a.y,c.realHeight);n=a.longitudes;e=a.latitudes;p=n.length;if(0<p)for(v=[],C=[],x=0;x<p;x++)A=c.coordinatesToXY(n[x],e[x]),v.push(A.x),C.push(A.y);if(0<v.length){a.segments=v.length;d.dx=0;d.dy=0;var E,H,G,p=10*(1-Math.abs(z));10<=p&&(p=NaN);1>p&&(p=1);a.arcRadius=[];a.distances=[];n=c.mapContainer.scale;if(isNaN(p)){for(p=0;p<v.length-1;p++)H=Math.sqrt(Math.pow(v[p+1]-v[p],2)+Math.pow(C[p+1]-C[p],2)),a.distances[p]=H;p=d.line(w,
v,C,l,1,F/n,k,!1,!1,!0);l=d.line(w,v,C,l,.001,5/n,k,!1,!1,!0);p.setAttr("stroke-linecap","round")}else{x=1;0>z&&(x=0);A={fill:"none",stroke:l,"stroke-opacity":1,"stroke-width":F/n,"fill-opacity":0,"stroke-linecap":"round"};void 0!==k&&0<k&&(A["stroke-dasharray"]=k);for(var k="",D=0;D<v.length-1;D++){var K=v[D],J=v[D+1],L=C[D],O=C[D+1];H=Math.sqrt(Math.pow(J-K,2)+Math.pow(O-L,2));G=H/2*p;E=270+180*Math.acos(H/2/G)/Math.PI;isNaN(E)&&(E=270);if(K<J){var P=K,K=J,J=P,P=L,L=O,O=P;E=-E}0<z&&(E=-E);k+="M"+
...
this.arc&&(l=-l);h=c+(g-c)/2+Math.sqrt(k*k-l/2*(l/2))*(e-f)/l;var q=e+(f-e)/2+Math.sqrt(k*k-l/2*(l/2))*(g-c)/l;c=180*Math.atan2(e-q,c-h)/Math.PI;g=180*Math.atan2(f-q,g-h)/Math.PI;180<g-c&&(g-=360);m=d.degreesToRadians(c+(g-c)*a);h+=k*Math.cos(m);k=q+k*Math.sin(m);m=0<this.arc?m+Math.PI/2:m-Math.PI/2;m+=n}this.distance=l;return{x:h,y:k,angle:m}}},fixToStage:function(){if(0<this.latitudes.length){this.y=[];for(var a=0;a<this.latitudes.length;a++){var b=this.chart.coordinatesToStageXY(this.longitudes[a],
...
t>h&&(h=t);t<f&&(f=t);n>l&&(l=n);n<k&&(k=n);b="z"==q.toLowerCase()?b+"Z ":b+(q+" "+t+" "+n+" ")}a.setAttribute("d",b);return{minX:f,maxX:h,minY:k,maxY:l}};d.mercatorLatitudeToRadians=function(a){return Math.log(Math.tan(Math.PI/4+d.degreesToRadians(a)/2))};d.parsePath=function(a){a=a.match(/([MmLlHhVvZz]{1}[0-9.,\-\s]*)/g);for(var b=[],c=0;c<a.length;c++){var d=a[c].match(/([MmLlHhVvZz]{1})|([0-9.\-]+)/g),g={letter:d[0]};switch(d[0]){case "Z":case "Z":case "z":break;case "V":case "v":g.y=Number(d[1]);
