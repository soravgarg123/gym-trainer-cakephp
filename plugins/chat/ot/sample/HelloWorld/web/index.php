...
require_once($_SERVER['DOCUMENT_ROOT']."/tok/opentok.phar");
...
use OpenTok\OpenTok;
$apiKey = 45342972;
$secretkey = "802ad098cc7d3386c08a8461f5435d2f88121fc5";
...
$app->container->singleton('opentok', function () {
    return new OpenTok($apiKey,$secretkey);
});
// Store the API Key in the app container
$app->apiKey = $apiKey; //getenv('API_KEY');
